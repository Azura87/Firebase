...
import com.example.datafriend.databinding.ActivityMainBinding
        ...
        when (p0?.getId()) {
            ...
            R.id.save -> {
                ...
                if (isEmpty(getNama) || isEmpty(getAlamat) || isEmpty(getNoHP)) {
                    ...
                    getReference.child("Admin").child(getUserID).child("DataFriend").push()
                        .setValue(data_teman(getNama, getAlamat, getNoHP))
                        .addOnCompleteListener(this) {
                            //bagian ini terjadi ketia user berhasil menyimpan data
